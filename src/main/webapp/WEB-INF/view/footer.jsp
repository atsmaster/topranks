	...
	<div id="footer" role="contentinfo">
		<div class="footer_inner">
			<div class="banner_area">
				<div class="da_box_wrap">
					<div id="da_public_left">
						<iframe id="da_iframe_bottom_left" title="광고" width="350" height="86" scrolling="no" frameborder="0" src="https://siape.veta.naver.com/fxshow?su=SU10641&amp;nrefreshx=0"></iframe>
					</div>
					<div id="da_public_right">
						<iframe id="da_iframe_bottom_right" title="광고" width="350" height="86" scrolling="no" frameborder="0" src="https://siape.veta.naver.com/fxshow?su=SU10642&amp;nrefreshx=0"></iframe>
					</div>
					<div id="veta_time2">
						<iframe id="da_iframe_below" name="da_iframe_below" data-veta-preview="main_below" width="350" height="86" scrolling="no" frameborder="0" title="광고" src="https://siape.veta.naver.com/fxshow?su=SU10640&amp;nrefreshx=0"></iframe>
					</div>
				</div>
			</div>
			<div class="notice_area" data-clk-prefix="ntc">
				...
				<a href="/" class="link_all" data-clk="svcmap">서비스 전체보기</a>
			</div>
			<div class="aside_area">
				<div class="partner_box_wrap">
					<div class="partner_box" data-clk-prefix="crt">
						<h3 class="title">Tistory</h3>
						<a href="https://semochuree.tistory.com/" class="link_partner" data-clk="creator">semochuree.tistory.com</a>
					</div>
					<div class="partner_box" data-clk-prefix="crt">
						<h3 class="title">blog</h3>
						<a href="https://blog.naver.com/jashan6"
							class="link_partner" data-clk="sme">blog.naver.com</a>
					</div>
				...
				<div class="service_box_wrap">
					<div class="service_box" data-clk-prefix="wbd">
						<a href="http://whale.naver.com/" class="service_logo"
							...
							alt="웨일" width="48" height="48" target="_blank">
						</a>
						<div class="service_info">
							<strong class="title">웨일 브라우저</strong>
							<a href="http://whale.naver.com/" class="dsc" data-clk="bt" target="_blank">바로가기</a>
						</div>
					</div>
					<div class="service_box" data-clk-prefix="prj">
						<a
							...
							class="service_logo" data-clk="link" target="_blank"> <img
						...
						<div class="service_info">
							<strong class="title">프로젝트 꽃</strong> <a
								href="https://search.naver.com/search.naver?where=nexearch&amp;sm=top_hty&amp;fbm=1&amp;ie=utf8&amp;query=%ED%94%84%EB%A1%9C%EC%A0%9D%ED%8A%B8%EA%BD%83"
								class="dsc" data-clk="link" target="_blank">바로가기</a>
						</div>
					</div>
				</div>
			</div>
			<div class="corp_area" data-clk-prefix="plc">
				<h3 class="blind">연락처 및 회사소개</h3>
				<ul class="list_corp">
					<li class="corp_item">jashan6@naver.com | 010-9367-4096 |</li>
					
				</ul>
				<address class="addr">
					<a href="/" target="_blank" data-clk="nhn">ⓒ
						SEMO CHUREE Corp.</a>
				</address>
			</div>
		</div>
